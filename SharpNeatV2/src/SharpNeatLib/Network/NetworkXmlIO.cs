...
namespace SharpNeat.Network
{
    ...
    public static class NetworkXmlIO
    {
        ...
        private static Dictionary<string, IActivationFunction> _activationFunctions = new Dictionary<string, IActivationFunction>()
        {
        ...
        /// <summary>
        /// Adds a mapping from a short name to an IActivationFunction.
        /// </summary>
        /// <param name="name"></param>
        /// <param name="defaultInstance"></param>
        public static void AddActivationFunction(string name, IActivationFunction defaultInstance)
        {
            _activationFunctions.Add(name, defaultInstance);
        }
        ...
        public static IActivationFunction GetActivationFunction(string name)
        {
            ...
            if (_activationFunctions.TryGetValue(name, out result))
                return result;
